...
const rentals = [
  { id: 'cafetal', type: 'casa', price: 650, guests: 6, beds: 3, baths: 2, parking: 2, sqmBuilt: 140, sqmLot: 800, minMonths: 3, verified: true, availableFrom: '', rating: 4.9, reviews: 128, name: { es: 'Cabaña El Cafetal', en: 'El Cafetal Cabin' }, loc: { es: 'Bajo Mono, Boquete', en: 'Bajo Mono, Boquete' }, short: { es: 'Cabaña de madera amueblada rodeada de cafetales, con chimenea y vistas al bosque nuboso. Acepta mascotas.', en: 'Furnished wooden cabin surrounded by coffee farms, with a fireplace and cloud-forest views. Pet friendly.' }, desc: { es: 'A diez minutos del pueblo, esta cabaña de madera se levanta en medio de una finca de café, ideal para alquilar por meses.', en: 'Ten minutes from town, this wooden cabin sits in the middle of a working coffee farm, ideal for a monthly rental.' }, host: { name: 'Roberto Achú', line: { es: 'Caficultor y propietario desde 2018', en: 'Coffee grower and owner since 2018' }, phone: '+507 6234-5678', email: 'roberto@livingboquete.com' }, amen: ['wifi', 'kitchen', 'view', 'parking', 'fireplace', 'furnished', 'pets'], reviewsList: [{ name: 'James Carter', rating: 5, date: { es: 'Junio 2026', en: 'June 2026' }, text: { es: 'Despertar entre cafetales no tiene precio.', en: 'Waking up among coffee plants is priceless.' } }], img: img('cabin-coffee-farm', 800, 560), lat: 8.7942, lng: -82.4467 },
  { id: 'niebla', type: 'habitacion', price: 380, guests: 2, beds: 1, baths: 1, parking: 1, sqmBuilt: 32, sqmLot: 0, minMonths: 1, verified: true, availableFrom: '', rating: 4.8, reviews: 94, name: { es: 'Habitación Jardín de Niebla', en: 'Jardín de Niebla Room' }, loc: { es: 'Alto Boquete', en: 'Alto Boquete' }, short: { es: 'Habitación privada amueblada en casa familiar, con jardín de orquídeas.', en: 'Furnished private room in a family home, with an orchid garden.' }, desc: { es: 'Habitación privada dentro de una casa familiar rodeada de jardines de orquídeas, ideal para estadías largas.', en: 'A private room inside a family home surrounded by orchid gardens, ideal for extended stays.' }, host: { name: 'Elena Caballero', line: { es: 'Propietaria y jardinera', en: 'Owner and gardener' }, phone: '+507 6345-6789', email: 'elena@livingboquete.com' }, amen: ['wifi', 'kitchen', 'furnished', 'parking'], reviewsList: [{ name: 'Ana Lucía Rivas', rating: 5, date: { es: 'Junio 2026', en: 'June 2026' }, text: { es: 'Llevo tres meses viviendo aquí y Elena se siente como familia.', en: 'I have lived here for three months and Elena feels like family.' } }], img: img('bnb-orchid-valley', 800, 560), lat: 8.7835, lng: -82.4389 },
  { id: 'caldera', type: 'apto', price: 550, guests: 4, beds: 2, baths: 1, parking: 1, sqmBuilt: 88, sqmLot: 0, minMonths: 6, verified: false, availableFrom: '2026-08-15', rating: 4.7, reviews: 76, name: { es: 'Apartamento Río Caldera', en: 'Río Caldera Apartment' }, loc: { es: 'Centro de Boquete', en: 'Downtown Boquete' }, short: { es: 'Apartamento moderno sin amueblar, junto al río.', en: 'Modern unfurnished apartment by the river.' }, desc: { es: 'Un apartamento luminoso y moderno a orillas del río Caldera, disponible para alquiler mensual sin amueblar.', en: 'A bright, modern apartment on the banks of the Caldera river, available as an unfurnished monthly rental.' }, host: { name: 'Lucía Samudio', line: { es: 'Propietaria', en: 'Owner' }, phone: '+507 6456-7890', email: 'lucia@livingboquete.com' }, amen: ['wifi', 'kitchen', 'parking', 'pool'], reviewsList: [{ name: 'Carlos Méndez', rating: 5, date: { es: 'Junio 2026', en: 'June 2026' }, text: { es: 'Ubicación inmejorable.', en: 'Unbeatable location.' } }], img: img('apartment-river', 800, 560), lat: 8.7761, lng: -82.4312 },
  { id: 'mirador', type: 'casa', price: 1300, guests: 8, beds: 4, baths: 3, parking: 3, sqmBuilt: 220, sqmLot: 1200, minMonths: 3, verified: true, availableFrom: '', rating: 5.0, reviews: 61, name: { es: 'Casa Mirador del Barú', en: 'Mirador del Barú House' }, loc: { es: 'Volcancito, Boquete', en: 'Volcancito, Boquete' }, short: { es: 'Casa amplia y amueblada con vista directa al Volcán Barú, acepta mascotas.', en: 'Spacious furnished house with direct views of Barú Volcano, pet friendly.' }, desc: { es: 'Una casa amplia pensada para familias que se mudan a vivir a Boquete, con vista frontal al Volcán Barú.', en: 'A spacious house designed for families relocating to live in Boquete, with a front view of Barú Volcano.' }, host: { name: 'Diego Pittí', line: { es: 'Propietario local', en: 'Local owner' }, phone: '+507 6567-8901', email: 'diego@livingboquete.com' }, amen: ['wifi', 'kitchen', 'view', 'parking', 'pool', 'fireplace', 'furnished', 'pets'], reviewsList: [{ name: 'Thomas Dubois', rating: 5, date: { es: 'Mayo 2026', en: 'May 2026' }, text: { es: 'La vista al volcán es de otro mundo.', en: 'The volcano view is out of this world.' } }], img: img('volcano-view-house', 800, 560), lat: 8.8015, lng: -82.4521 },
];
